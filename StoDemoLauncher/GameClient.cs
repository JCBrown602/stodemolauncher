...
// end constructor
        ...
        {
            return System.IO.File.Exists(path + "\\Star Trek Online.exe") && GameClient.ValidateServerPath(path + "\\Star Trek Online\\Live\\x86");
        }
        ...
        {
            return this.GetPath(server) + "\\x86\\GameClient.exe";
        }
